<fieldset>
  ...
  <div class="form-group">
    Enter working time:
    <div class="number-box">
        <input type="text" class="form-control time" name="working_time" maxlength="2"/> : <input type="text" class="form-control time" name="working_time_two" maxlength="2"/>
        h -
        <input type="text" class="form-control time" name="working_time_three" maxlength="2"/> : <input type="text" class="form-control time" name="working_time_four" maxlength="2"/> h
    </div>
